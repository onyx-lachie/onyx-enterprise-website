      ...
      <div className="max-w-[1280px] mx-auto px-6 py-12 mt-[72px] relative z-10">
        ...
        >
          ...
          <p className="text-lg text-[#6E7180] max-w-[600px] mx-auto">
            Schedule a personalized demo and see how Onyx can transform your insurance business.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-white rounded-2xl shadow-xl border border-[#E8EAF0] p-6 md:p-8">
            <iframe
              id="W2Wu8sAkmIT6O4zeTByD_1769670995555"
              src="https://link.onyx-crm.com/widget/booking/Kgr0a3KrGvLbRJNS0JFE"
              style={{
                width: '100%',
                height: '700px',
                border: 'none',
